defmodule SecretwordsWeb do
  ...
  def controller do
    quote do
      use Phoenix.Controller, namespace: SecretwordsWeb
  ...
  def view do
    quote do
      use Phoenix.View,
        root: "lib/secretwords_web/templates",
        namespace: SecretwordsWeb
